...
NAME=({ALPHA}+{DIGIT}*)
PLATFORM=([^{WS_CHARS}{EQ}{SBRACKETS_CHARS}{SEMICOLON}{COLON}{OPERATORS}{BACKSLASH}][^{NEWLINE_CHARS}{EQ}{SBRACKETS_CHARS}{SEMICOLON}{COLON}]*{COLON})

SECTION_NAME=([^{WS_CHARS}{SBRACKETS_CHARS}]+)
PROP_KEY=([^{WS_CHARS}{EQ}{COLON}{SBRACKETS_CHARS}{OPERATORS}{BACKSLASH}][^{WS_CHARS}{EQ}{COLON}{SBRACKETS_CHARS}]*)
PROP_VAL=([^{WS_CHARS}{BRACKETS_CHARS}{EQ}{QUOTE_MK}{BACKSLASH}][^{WS_CHARS}]*)
OBJECT_VAL=([^{WS_CHARS}{COMMA}{BRACKETS_CHARS}{EQ}{QUOTE_MK}{BACKSLASH}][^{WS_CHARS}{COMMA}{EQ}{BRACKETS_CHARS}]*)
...
<YYINITIAL, YY_IN_VALUE, YY_IN_OBJECT_VAL, YY_IN_OBJECT_KEY> {BACKSLASH} { return GetToken(IniTokenType.LINESPLITTER); }
